...
Pre-trained model
------------
You can find a pre-trained model of the pushing task [here](). It will be loaded automatically if you run ``sample.py`` using the default parameters. The training took a few hours on a GTX 1070 GPU.
